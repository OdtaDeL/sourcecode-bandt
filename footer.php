                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="">147 Đ. Cách Mạng Tháng 8, Phường 10, Quận 3, Thành phố Hồ Chí Minh</a></li>
                            <li><a href="">Hotline: 0963.781.563</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
                                ...
                                </script> All rights reserved <i class="ti-heart" aria-hidden="true"></i> by <a href="/" target="_blank">Smobile</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </P>
                        </div>
                    </div>
