            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    foreach (selectAll("SELECT * FROM slide") as $item) {
                        $flag = true;
                        foreach (selectAll("SELECT id FROM sanpham where status = 1") as $id) {
                            if ((int)explode("=", $item['link'])[1] == (int)$id['id']) {
                                $flag = false;
                                break;
                            }
                        }
                        ...
                        <div class="single_banner_slider">
                            <div class="row">
                                ...
                                <div class="banner_img d-none d-lg-block col-lg-7 col-md-8">
